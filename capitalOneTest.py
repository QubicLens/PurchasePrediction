...
print(requests.delete(url = "http://api.reimaginebanking.com/data?type=Accounts&key=2bd4021425dbdbbb6aafac992c0ad0a8").status_code)
...
print(requests.post(url = "http://api.reimaginebanking.com/customers/5f82eb13f1bac107157e1bf1/accounts?key=2bd4021425dbdbbb6aafac992c0ad0a8", data = json.dumps(account), headers = {'content-type':'application/json'}).text)
